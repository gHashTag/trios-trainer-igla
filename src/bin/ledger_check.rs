...
//!
//! Read-side companion to [`trios_trainer::race::check_victory`]. Consumes
...
//! [`trios_trainer::race::VictoryError`].  (5) is reported as a typed
//! [`trios_trainer::race::TtestError`] or as a non-passing
...
//! `trios_trainer::race::*` (re-exported from `victory.rs`,
