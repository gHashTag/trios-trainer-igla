...
use trios_trainer::invariants::{PHI, PHI_SQ};
...
///
/// Re-uses the already-traced `trios_trainer::race::PHI_SQ` constant; the doc
...
mod tests {
    ...
    fn constants_traceable() {
        ...
        assert_eq!(PHI, trios_trainer::invariants::PHI);
        assert_eq!(PHI_SQ, trios_trainer::invariants::PHI_SQ);
