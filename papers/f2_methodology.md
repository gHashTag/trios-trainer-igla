...
`papers/scripts/generate_appendix_d.sh`) lists 830 tests grouped by
source: 735 in `src/lib.rs`, the remainder distributed across
...
The full test inventory (830 tests across `src/lib.rs`, 10 F2 binaries,
