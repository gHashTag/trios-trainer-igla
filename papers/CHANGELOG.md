...
- **Loop 162** — attention bench hardened: STEPS 200 → 800, HIDDEN
  ...
  The GF16 penalty exploded **17× vs the 200-step attention run**
  once the model was given a converged budget (+0.010 → +0.173
  BPB), while Posit16's penalty stayed within MC SE noise (+0.004
  BPB ≈ 0.5× MC SE). 81st adversarial pass dispatched. PDF page
  counts: non-anon 52 → 53; anon and TMLR unchanged at 52 / 33.
