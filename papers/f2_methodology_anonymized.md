<!-- ANONYMIZED VARIANT — auto-generated by papers/scripts/anonymize_paper.py. Do not edit by hand. Modify papers/f2_methodology.md and re-run the script. -->
...
in (internal ref) against the regenerated `--mode all` canonical sweep
