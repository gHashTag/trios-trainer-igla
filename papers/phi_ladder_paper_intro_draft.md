...
The companion paper's CI gate (32 stages on disk as of Loop 139)
...
**32-stage on-disk gate** breaks down as
**26 F2-scope stages** (cross-ref/metadata/SHAs/lint/tables/
...
the module-cache-consistency verifier, and the floating-loop-
anchor verifier; per-introduction history is catalogued in the
