...
The companion paper's CI gate (20 stages on disk as of Loop 121)
...
verifiers): the current **20-stage on-disk gate** breaks down as
**14 F2-scope stages** (cross-ref/metadata/SHAs/lint/tables/
