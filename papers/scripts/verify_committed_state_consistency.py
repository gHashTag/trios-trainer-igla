...
EXCLUDE_PATHS = {
    ...
    # Loop 137 — 60th-pass SEV-4 fix #7: xelatex compile logs are
    # regenerated by `compile_tmlr_test.sh` with timestamps embedded.
    "papers/tmlr_submission_kit/test_compile_anon.xelatex.log",
    "papers/tmlr_submission_kit/test_compile_tmlr.xelatex.log",
}
