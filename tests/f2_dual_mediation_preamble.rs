...
fn dual_mediation_reads_csv_with_provenance_preamble() {
    ...
    writeln!(f, "# prov:wasGeneratedBy = f2_ablation_sweep --mode all --steps 200").unwrap();
...
fn dual_mediation_reads_csv_with_preamble_and_wd0_stratum() {
    ...
    writeln!(f, "# prov:wasGeneratedBy = f2_ablation_sweep --mode wd_stratified --steps 200").unwrap();
